  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={()=> setOpen(false)}>
                <img className="h-9"  src={assets.agriLink} alt="dummyLogoColored" />
            </NavLink>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <NavLink to='/crop'>Crop Selection</NavLink>
                ...
                (
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadowborder border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
            ...
            { open &&(
                ...
                <NavLink to='/crop' onClick={()=> setOpen(false)}>Crop Selection</NavLink>
